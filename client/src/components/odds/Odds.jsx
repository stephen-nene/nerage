...
const options = [
    { value: 'unibet', label: 'Unibet', url: 'https://www.unibet.co.uk/betting/sports' },
    { value: '10bet', label: '10Bet', url: 'https://www.10bet.co.uk/sports/' },
    { value: 'skybet', label: 'Sky Bet', url: 'https://www.skybet.com/' },
    { value: 'marathonbet', label: 'Marathonbet', url: 'https://www.marathonbet.com/en/' },
    { value: 'hollywoodbets', label: 'Hollywoodbets', url: 'https://www.hollywoodbets.net/' },
    { value: 'sportpesa', label: 'SportPesa', url: 'https://www.ke.sportpesa.com/' },
    ...
    { value: 'betfair', label: 'Betfair', url: 'https://www.betfair.com/sport/inplay' }
  ];
...
export default function Odds() {
  ...
  <div className="text-center flex flex-col justify-center mt-5">
      ...
      <div className="w-64 mt-4 mx-auto">
        <Select className="bg-gray-500 text-black" options={options} isSearchable={true} isClearable={false} value={selectedOption} placeholder='select a site' onChange={handleChange} components={animatedComponents}/>
